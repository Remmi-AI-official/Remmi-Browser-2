...
data class FallbackNetworkRule(
  ...
  private fun matchesType(filterType: String, actualType: String): Boolean {
    ...
    if (f == "popup" && (a == "popup" || a == "main_frame")) return true
    return false
  }
}
...
class AdblockBridge {
      ...
      synchronized(compileLock) {
        ...
        try {
          ...
          synchronized(swapLock) {
            ...
            val newBuiltEngine = FallbackEngineSet(
              blockedHostnames = newBlockedHostnames,
              blockedSubstrings = newBlockedSubstrings,
              allowList = newAllowList,
              fallbackNetworkRules = newNetworkRules,
            ...
            activeFallbackEngine = newBuiltEngine
          ...
          // Hint garbage collection to immediately free raw rule strings and temporary parse buffers
          System.gc()
  ...
  companion object {
    ...
    val DEFAULT_DOMAINS = listOf(
      ...
      "popcash.net", "propellerads.com", "monetag.com", "adcash.com",
      "exoclick.com", "hilltopads.net", "clickadu.com", "adsterra.com",
      "trafficjunky.net", "richpush.co", "evadav.com", "deloton.com",
      "g2288.com", "ayhal.com", "mynahsterfez.shop",
    ...
    val DEFAULT_PATTERNS = listOf(
      ...
      "afu.php", "/sm-click", "/popunder", "/pop-up", "/clicktag"
    )
