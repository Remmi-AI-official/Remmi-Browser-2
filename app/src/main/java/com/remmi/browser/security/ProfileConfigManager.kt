...
class ProfileConfigManager(private val context: Context) {
  ...
  fun generateShieldPrefs(dohUri: String = "https://cloudflare-dns.com/dns-query"): String {
    return buildString {
      ...
      appendLine("""user_pref("privacy.fingerprintingProtection", false);""")
      appendLine("""user_pref("privacy.fingerprintingProtection.overrides", "-CanvasRandomization,-CanvasExtraction,-CanvasImageExtractionPrompt,-CanvasExtractionFromThirdPartiesIsBlocked,-CanvasExtractionBeforeUserInputIsBlocked,-CanvasKeyedPrompt");""")
      ...
      appendLine("""user_pref("privacy.resistFingerprinting.autoDeclineNoUserInputCanvasPrompts", false);""")
  ...
  fun generateTorYamlConfig(socksPort: Int = 9050): String {
    return buildString {
      ...
      appendLine("  privacy.resistFingerprinting.letterboxing: false")
      appendLine("  privacy.fingerprintingProtection: false")
      appendLine("""  privacy.fingerprintingProtection.overrides: "-CanvasRandomization,-CanvasExtraction,-CanvasImageExtractionPrompt,-CanvasExtractionFromThirdPartiesIsBlocked,-CanvasExtractionBeforeUserInputIsBlocked,-CanvasKeyedPrompt"""")
      appendLine("  privacy.resistFingerprinting.randomDataOnCanvasExtract: false")
      appendLine("  privacy.resistFingerprinting.autoDeclineNoUserInputCanvasPrompts: false")
